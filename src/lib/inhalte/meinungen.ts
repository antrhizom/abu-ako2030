...
export const handlungskompetenzenMeinungen: ThemaHandlungskompetenzen = {
  ...
  lebensbezuege: [
    {
      nr: "2.1",
      kurz: "Information & Desinformation",
      ...
      lerninhalte: [
        {
          nr: "2.1.1",
          kurz: "Politische Beitr�ge verstehen",
    ...
    {
      nr: "2.2",
      kurz: "Ausgrenzung & Meinungsfreiheit",
      ...
      lerninhalte: [
        {
          nr: "2.2.1",
          kurz: "Diskriminierung analysieren",
